...
token="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"

client = Groq(api_key="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")
...
def call_chat_bot(name:str):
    avatars = {
        'junoir':'./icons/junoir.png',
        'senoir':'./icons/senoir.png',
...
def opus_orchestrator(objective: str, file_content: str = None, previous_results: list = None):
    ...
    try:
        ...
        # console.print(Panel(f"Error calling Orchestrator: {e}", title="[bold red]Orchestrator Error[/bold red]", title_align="left", border_style="red"))
        senoir.markdown(f"Error calling Orchestrator: {e}")
        return "", file_content

def haiku_sub_agent(prompt: str, previous_haiku_tasks: list = None, continuation: bool = False):
    """
    ...
    try:
        ...
        # console.print(Panel(f"Error calling Sub-agent: {e}", title="[bold red]Sub-agent Error[/bold red]", title_align="left", border_style="red"))
        junoir.markdown(f"Error calling Sub-agent: {e}")
        return ""
    
def opus_refine(objective: str, sub_task_results: list, filename: str, projectname: str, continuation: bool = False):
    """
    ...
    try:
        ...
        # console.print(Panel(f"Error calling Refiner: {e}", title="[bold red]Refiner Error[/bold red]", title_align="left", border_style="red"))
